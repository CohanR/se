  ...
  "cells": [
    ...
    },
    {
      ...
      "source": [
        ...
        "\n",
        "But don’t be a robot about it. Before you interpret anything in a TMS threshold dataset, you do quick checks:\n",
        "\n",
        "1) Are the columns you need actually there?\n",
        "2) Are there obviously impossible / suspicious rMT values?\n",
        "3) Do you have any duplicate participant rows?\n",
        "\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "# Print ONLY the participants that appear more than once.\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "print(delta_summary)\n",
        "\n",
        "# NEW: responder-style summary (still simple): what % of people decreased rMT (delta < 0)?\n",
        "# This is not a statistical test. It’s just a descriptive \"how many went down\" check.\n",
        "responder_rate = # add your code here\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "\n",
        "4) Print the % of participants with ΔrMT < 0 for Active vs Sham (you already computed this in Q3, so reuse it)."
      ]
    },
    {
      "cell_type": "code",
      ...
      "source": [
        ...
        "print(mean_change)\n",
        "\n",
        "# Re-print the responder-style summary (% with delta < 0) to keep this question self-contained\n",
        "responder_rate = # add your code here\n",
        "print(\"% with ΔrMT < 0 (by condition):\")\n",
        "print(responder_rate)\n",
        "\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "\n",
        "# NEW: direction helper (still requires you to choose A/B/C in your write-up)\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "\n",
        "Use your outputs from Q3/Q4 (mean change post − pre by condition + % with ΔrMT < 0) and Q5 (correlation strength category).\n",
        "\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "q6_resp = (data['delta_rMT'] < 0).groupby(data['condition']).mean().mul(100).round(1)\n",
        "\n",
        ...
        "print(q6_resp)\n",
        "\n",
        "sig_q6 = round(float(q6_means.values.sum()) + float(q6_resp.sum()), 3)\n",
